...
void RenderFavoritesTab()
{
    ...
    if (ImGui::BeginTabItem(Localization::GetText("tab_items")))
    {
        ...
        ImGui::Spacing();
        ImGui::Text("%s", Localization::GetText("manage_favorite_items"));
        ImGui::Spacing();

        size_t favoriteItemsCount = favoriteItems.size();
        ImVec4 favoriteItemsColor = favoriteItemsCount > 0 ? ImVec4(1.f, 0.84f, 0.f, 1.f) : ImVec4(1.f, 1.f, 1.f, 1.f);
        ImGui::TextColored(favoriteItemsColor, "%s %zu", Localization::GetText("favorite_items_label"), favoriteItemsCount);

        ImGui::Spacing();
        if (ImGui::Button(Localization::GetText("clear_all_favorite_items")))
        {
            ImGui::OpenPopup("ClearAllFavoriteItemsConfirm");
        }
    ...
    if (ImGui::BeginTabItem(Localization::GetText("tab_currencies")))
    {
        ...
        ImGui::Spacing();
        ImGui::Text("%s", Localization::GetText("manage_favorite_currencies"));
        ImGui::Spacing();

        size_t favoriteCurrenciesCount = favoriteCurrencies.size();
        ImVec4 favoriteCurrenciesColor = favoriteCurrenciesCount > 0 ? ImVec4(1.f, 0.84f, 0.f, 1.f) : ImVec4(1.f, 1.f, 1.f, 1.f);
        ImGui::TextColored(favoriteCurrenciesColor, "%s %zu", Localization::GetText("favorite_currencies_label"), favoriteCurrenciesCount);

        ImGui::Spacing();
        if (ImGui::Button(Localization::GetText("clear_all_favorite_currencies")))
        {
            ImGui::OpenPopup("ClearAllFavoriteCurrenciesConfirm");
        }
