...
namespace Localization
{
    const std::unordered_map<std::string, const char*> GetEnglishTranslations()
    {
        static const std::unordered_map<std::string, const char*> translations = {
            ...
            {"enable_profit_tab", "Enable Profit Tab"},
            {"enable_profit_tab_tooltip", "Show the Profit tab"},
            ...
            // Summary Tab - Headers
            {"top_items_profit_header", "Top 10 Items by Profit"},
            {"top_items_count_header", "Top 10 Items (Count)"},
            {"top_currencies_count_header", "Top 10 Currencies (Count)"},
