...
void RenderFilterTab()
{
    ...
    if (g_Settings.showRangeFilters)
    {
        ...
        if (ImGui::InputInt("G##MinPriceGold", &g_Settings.filterMinPriceGold, 0))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_min_price_tooltip"));
        ImGui::SameLine();
        ImGui::SetNextItemWidth(60);
        if (ImGui::InputInt("S##MinPriceSilver", &g_Settings.filterMinPriceSilver, 0))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_min_price_tooltip"));
        ImGui::SameLine();
        ImGui::SetNextItemWidth(60);
        if (ImGui::InputInt("C##MinPriceCopper", &g_Settings.filterMinPriceCopper, 0))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_min_price_tooltip"));
        ...
        ImGui::SameLine();
        ImGui::SetNextItemWidth(60);
        if (ImGui::InputInt("G##MaxPriceGold", &g_Settings.filterMaxPriceGold, 0))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_max_price_tooltip"));
        ImGui::SameLine();
        ImGui::SetNextItemWidth(60);
        if (ImGui::InputInt("S##MaxPriceSilver", &g_Settings.filterMaxPriceSilver, 0))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_max_price_tooltip"));
        ImGui::SameLine();
        ImGui::SetNextItemWidth(60);
        if (ImGui::InputInt("C##MaxPriceCopper", &g_Settings.filterMaxPriceCopper, 0))
            SettingsManager::Save();
        if (ImGui::IsItemHovered())
            ImGui::SetTooltip("%s", Localization::GetText("filter_max_price_tooltip"));
